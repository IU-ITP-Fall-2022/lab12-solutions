...
public class Main {
    private static int divideFromFile(String inputFile) throws DivideFromFileException {
        try(FileInputStream in = new FileInputStream(inputFile)) {
            ...
            throw new DivideFromFileException(e.getMessage());
    ...
    public static void main(String[] args) {
        ...
        } catch (DivideFromFileException e) {
